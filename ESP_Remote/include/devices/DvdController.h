...
class DvdController : public DeviceController {
 public:
  struct KeyCommand {
    const char *key;
  ...
  DvdController(const char *nodeId, uint8_t irPin);

  const char *deviceType() const override { return "dvd"; }
