...
class ProjectorController : public DeviceController {
 public:
  struct KeyCommand {
    const char *key;
  ...
  ProjectorController(const char *nodeId, uint8_t irPin);

  const char *deviceType() const override { return "projector"; }
